...
function SideComponentProfile() {
  return (
    ...
    <div class="mt-6  xmd:w-[42vw] xnm:w-[100%] lg:w-[35vw] w-[29.7vw] overflow-hidden rounded-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
      <div class="p-3">
...
export default SideComponentProfile